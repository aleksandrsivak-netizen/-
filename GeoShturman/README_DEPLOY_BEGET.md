...
Нажмите **«Запустить демонстрацию»** — должны появиться азимут, скорость, корреляция,
RMSE, карта высот с траекторией, heatmap, сравнение профилей и ссылки на скачивание.
